...
// --- セクション3: 支出・CFテーブル（毎年） ---
function expenseTableSection(yrs: YearResult[]): string {
...
// --- セクション4: 資産残高テーブル（毎年） ---
function assetTable(yrs: YearResult[]): string {
...
import { LLM_ANALYSIS_PROMPT } from "./reportAnalysisPrompt";
