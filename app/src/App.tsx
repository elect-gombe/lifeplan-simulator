...
function migrateScenario(s: any, oldFields?: any): Scenario {
  return {
    ...
    pensionAnnualMan: s.pensionAnnualMan ?? 180,
    dcReceiveMethod: s.dcReceiveMethod ?? { type: "lump_sum", annuityYears: 20, annuityStartAge: 65, combinedLumpSumRatio: 50 },
    spouse: s.spouse ? {
      retirementAge: 65,
      ...s.spouse,
    } : { enabled: false, currentAge: 30, retirementAge: 65, incomeKF: [], expenseKF: [], dcTotalKF: [], companyDCKF: [], idecoKF: [], salaryGrowthRate: 2, sirPct: 15.75, hasFurusato: true, pensionStartAge: 65, pensionAnnualMan: 100 },
...
function mkScenario(id: number): Scenario {
  ...
  return {
    ...
    pensionStartAge: 65, pensionAnnualMan: 180,
    dcReceiveMethod: { type: "lump_sum", annuityYears: 20, annuityStartAge: 65, combinedLumpSumRatio: 50 },
    spouse: { enabled: false, currentAge: 28, retirementAge: 65, incomeKF: [], expenseKF: [], dcTotalKF: [], companyDCKF: [], idecoKF: [], salaryGrowthRate: 2, sirPct: 15.75, hasFurusato: true, pensionStartAge: 65, pensionAnnualMan: 100 },
